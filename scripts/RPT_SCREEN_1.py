...
transSQL = '''
  SELECT DISTINCT
    MDM_HCP_ID AS HCP_ID,
    CONCAT_WS(' ', MDM_HCP_FNAME, MDM_HCP_MNAME, MDM_HCP_LNAME) AS HCP_NAME,
    CAST(MDM_HCP_NPI AS STRING) AS HCP_NPI,
    CONCAT_WS(',', VEEVA_HCP_ADDR_LN_1, VEEVA_HCP_CITY, VEEVA_HCP_ST, VEEVA_HCP_ZIP) AS HCP_ADDR
  FROM F_CUSTOMER
'''

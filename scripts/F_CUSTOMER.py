...
transSQL = '''
  SELECT DISTINCT
    MDM.MDM_HCP_ID AS MDM_HCP_ID,
    MDM.MDM_HCP_FNAME AS MDM_HCP_FNAME,
    MDM.MDM_HCP_MNAME AS MDM_HCP_MNAME,
    MDM.MDM_HCP_LNAME AS MDM_HCP_LNAME,
    CAST(MDM.MDM_HCP_NPI AS STRING) AS MDM_HCP_NPI,
    MDM.MDM_AFFIL_HCO_ID AS MDM_AFFIL_HCO_ID,
    VEEVA.VEEVA_HCP_ADDR_LN_1 AS VEEVA_HCP_ADDR_LN_1,
    VEEVA.VEEVA_HCP_ADDR_LN_2 AS VEEVA_HCP_ADDR_LN_2,
    VEEVA.VEEVA_HCP_CITY AS VEEVA_HCP_CITY,
    VEEVA.VEEVA_HCP_ST AS VEEVA_HCP_ST,
    VEEVA.VEEVA_HCP_ZIP AS VEEVA_HCP_ZIP
  FROM (
    SELECT DISTINCT
      MDM_HCP_ID, MDM_HCP_FNAME, MDM_HCP_MNAME, MDM_HCP_LNAME, MDM_HCP_NPI, MDM_AFFIL_HCO_ID
    FROM D_MDM
  ) MDM
  LEFT OUTER JOIN (
    SELECT DISTINCT
      MDM_HCP_ID, MDM_HCP_FNAME, MDM_HCP_MNAME, MDM_HCP_LNAME, MDM_HCP_NPI,
      VEEVA_HCP_ADDR_LN_1, VEEVA_HCP_ADDR_LN_2, VEEVA_HCP_CITY, VEEVA_HCP_ST, VEEVA_HCP_ZIP
    FROM D_VEEVA
  ) VEEVA
  ON MDM.MDM_HCP_NPI = VEEVA.MDM_HCP_NPI
'''
